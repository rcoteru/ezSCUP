...
ezSCUP is a Python module designed to facilitate the execution of SCALE-UP simulations in a parameter grid of temperatures, pressures, strains and/or electric fields, providing a high-level interface to handle the program and its output.
...
This module has been developed as part of my Bachelor's final-year thesis (as of yet unfinished).
