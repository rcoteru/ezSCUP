...
class Geometry():
            ...
            for y in range(self.supercell[1]):
                for z in range(self.supercell[2]):
                    ...
                    for j in range(self.nats):
                        ...
                        disps = list(self.B2A*(self.positions[x,y,z,j,:] + self.displacements[x,y,z,j,:]))
                        disps = ["{:.8E}".format(d) for d in disps]
    ...
    def write_xsf(self, xsf_file, comment=".xsf file automatically generated by ezSCUP."):
            ...
            for y in range(self.supercell[1]):
                for z in range(self.supercell[2]):
                    ...
                    for j in range(self.nats):
                        ...
                        disps = list(self.B2A*(self.positions[x,y,z,j,:] + self.displacements[x,y,z,j,:]))
                        disps = ["{:8.4F}".format(d) for d in disps]
