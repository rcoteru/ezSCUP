...
def STO_ROT(geom, model, angles=True):
...
def STO_AFE(geom, model):
    ...
    AFE_X=[  # atom, hopping, weight, target vector
            ...
            # "octahedra"
            [B,  [0, 0, 0], 0.7721715327/1., [ 1.0, 0.0, 0.0]],
    ...
    AFE_Y=[  # atom, hopping, weight, target vector
            ...
            # "octahedra"
            [B,  [0, 0, 0], 0.7721715327/1., [ 0.0, 1.0, 0.0]],
    ...
    AFE_Z=[  # atom, hopping, weight, target vector
            ...
            # "octahedra"
            [B,  [0, 0, 0], 0.7721715327/1., [0.0, 0.0, 1.0]],
...
def STO_OD(geom, model):
    ...
    OD_X=[  # atom, hopping, weight, target vector
            ...
            # "octahedra"
            [B,  [0, 0, 0], 0.1563428017/1., [-1.0, 0.0, 0.0]],
    ...
    OD_Y=[  # atom, hopping, weight, target vector
            ...
            # "octahedra"
            [B,  [0, 0, 0], 0.1563428017/1., [ 0.0,-1.0, 0.0]],
    ...
    OD_Z=[  # atom, hopping, weight, target vector
            ...
            # "octahedra"
            [B,  [0, 0, 0], 0.1563428017/1., [0.0, 0.0,-1.0]],
        ...
        for y in range(geom.supercell[1]):
            for z in range(geom.supercell[2]):
                ...
                for atom in FE_mode:
                    ...
                    charges = np.array(model["born_charges"][atom[0]])
